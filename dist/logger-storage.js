...
function all(key) {
  return new _promise2.default(function (resolve, reject) {
    try {
      ...
      if (items) {
        return resolve((0, _storage.getItem)(key));
      }
...
exports.infos = exports.warns = exports.errors = exports.logs = exports.filter = exports.all = exports.clear = undefined;
...
function logger(text) {
  ...
  var items = (0, _storage.getItem)(STORAGE_KEY) || [];
